...
export function GlassCard({ movie, item, onClick, className, aspect = "poster" }) {
    ...
    return (
        <motion.div
            ...
            className={twMerge("glass-card group cursor-pointer relative", className)}
            onClick={() => onClick(data)}
        >
            {/* Image Layer */}
            <div className={clsx("w-full overflow-hidden rounded-t-xl", aspect === "video" ? "aspect-video" : "aspect-[2/3]")}>
                <img
            ...
            {/* Content Layer (Always visible on mobile, hover on desktop) */}
